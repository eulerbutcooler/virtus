...
const LandingPage = lazy(() => import('./app/landing/LandingPage.jsx'))
...
const PageLoader = () => (
  <div style={{ height: 'calc(100vh - 100px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    <div style={{ width: '40px', height: '40px', borderRadius: '50%', border: '2px solid var(--border-default)', borderTopColor: 'var(--leaf-300)', animation: 'spin 1s linear infinite' }}></div>
  </div>
);
